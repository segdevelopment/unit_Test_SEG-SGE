...
public class TestsAvaliação {
    ...
    public void testDeCadastroNumero1() throws Throwable {
        ...
        while (true) {
            ...
            try {
                ...
                // "NOVO"
                Thread.sleep(1000);
                new Actions(navegador).moveByOffset(500, 25).click().perform();

                // GRUPO AÇÃO
                Thread.sleep(1000);
                new Actions(navegador).moveByOffset(-400, -50).click().perform();
                ...
                // SALVAR CADASTRO
                Thread.sleep(1000);
                new Actions(navegador).moveByOffset(100, -200).click().perform();


                Thread.sleep(1000);
                // Tirar “screenshot” no final da execução
                tirarScreenshot(navegador, "Cadastro_Avaliacao");
            } catch (Exception e) {
    ...
    private void tirarScreenshot(WebDriver navegador, String nomeArquivo) {
        try {
            ...
            File destinoFile = new File("C://Users//baptista.joao//Documents//Resultado Testes//Cadastro de Avaliação//"
